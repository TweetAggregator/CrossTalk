...
var rawData = JSON.parse('{"clusters": [{"centers": [{"x": 37.787, "y": -122.228, "r": -139.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]}]}');
...
function generateData(centers){
  ...
  for(var i = 0; i < centers.length; i++) {
    var e = centers[i];
    console.log("DA FUCKS "+JSON.stringify(centers[i]));
    console.log("DA e "+JSON.stringify(e));
    var bitch = JSON.parse('{"x": '+e.x+', "y": '+e.r+'}');
    console.log("DA bitch "+JSON.stringify(bitch));
    var border = geoToPx(bitch);
    var toPix = geoToPx(e);
    console.log("DA PIX "+JSON.stringify(toPix));
    var diff = border.y - toPix.y;
    console.log("Border "+JSON.stringify(border)+" diff "+diff );
