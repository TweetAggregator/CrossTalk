...
var rawData = JSON.parse('{"clusters": [{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]},{"centers": [{"x": 37.787, "y": -122.228, "r": -122.30}]}]}');
...
function generateData(centers){
  ...
  for(var i = 0; i < centers.length; i++) {
    ...
    var toPix = geoToPx(e),
        nR = Math.abs(geoToPx(copy).y - toPix.y);
